          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md relative">
              <div className="p-4">
                ...
                <div className="mb-5">We are seeking Senior React Developer to join our team in Boston,MA.
             ...
             <div className="bg-white rounded-xl shadow-md relative">
              <div className="p-4">
                ...
                <div className="mb-5">
                  Join our team as a Front-End Developer in sunny Miami,FL.We are looking for a motivated individual with passion...
                  </div>
                  <h3 className="text-indigo-500 mb-2">$70-$80k /Year</h3>
                  <div className="border border-gray-100 mb-5"></div>
              ...
              <div className="bg-white rounded-xl shadow-md relative">
                <div className="p-4">
                  ...
                  <div className="mb-5">
                    ...
                    Join our team in in vibrant Brooklyn,NY,and work and exciting projects that make a difference...
                  </div>
                  <h3 className="text-indigo-500 mb-2">$70-80k /Year</h3>
                  <div className="border border-gray-100 mb-5"></div>
                  <div className="flex flex-col lg:flex-row justify-between mb-4">
