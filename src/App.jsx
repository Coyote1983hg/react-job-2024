  ...
  return (
   ...
   <nav className="bg-indigo-700 border-b border-indigo-500">
    ...
    <section className="bg-indigo-700 py-20 mb-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg-px8 flex flex-col items-center">
      ...
      <div className="container-xl lg:container m-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <a href="/jobs.html" className="inline-block bg-black bg-indigo-500 text white rounded-lg px-4 py-2 hover:bg-indigo-600">Add Job</a>
          </div>
        </div>
      </div>
    </section>
